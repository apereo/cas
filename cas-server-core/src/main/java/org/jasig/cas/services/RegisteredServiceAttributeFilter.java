...
/**
 * Defines the general contract of the attribute release policy. 
 ...
 * @since 4.0.0
 * @see RegisteredServiceDefaultAttributeFilter
...
public interface RegisteredServiceAttributeFilter {
     ...
     * @return a map that contains the filtered attributes. The returned map can subsequently be passed down
     * to the filter chain for additional processing and refinement. 
     */
    Map<String, Object> filter(final String principalId, final Map<String, Object> givenAttributes, final RegisteredService svc);
}
