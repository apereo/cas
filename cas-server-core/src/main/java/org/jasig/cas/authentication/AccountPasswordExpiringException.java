 ...
 * @since 4.0
 */
public class AccountPasswordExpiringException extends AccountException {
    ...
    public AccountPasswordExpiringException(final String msg, final int days) {
        super(msg);
        this.numberOfDaysToPasswordExpirationDate = days;
    }

    public final int getNumberOfDaysToPasswordExpirationDate() {
