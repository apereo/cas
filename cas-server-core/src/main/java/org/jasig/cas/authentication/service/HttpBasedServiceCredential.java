...
/**
 * The Credential representing an HTTP-based service. HTTP-based services (such
 ...
 * @since 3.0
 */
public class HttpBasedServiceCredential implements Credential {
     ...
     * Credential object. Caches the value of URL.toExternalForm so updates to
