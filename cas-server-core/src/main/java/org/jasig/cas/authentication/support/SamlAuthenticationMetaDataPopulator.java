...
public class SamlAuthenticationMetaDataPopulator implements
    ...
    public final Authentication populateAttributes(final Authentication authentication, final Credential credential) {
     ...
     * <p>
     * Example: (<"org.jasig.cas.authentication.service.HttpBasedServiceCredential">
