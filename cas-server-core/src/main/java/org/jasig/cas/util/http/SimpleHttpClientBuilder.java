...
/**
 * The builder for a {@link SimpleHttpClient}.
 *
 * @author Jerome Leleu
 * @since 4.1.0
 */
public final class SimpleHttpClientBuilder {
    ...
    /** The executor service used to send requests. */
    private FutureRequestExecutionService requestExecutionService;

    /** The executor service used to create the {{@link #requestExecutionService}. */
    private ExecutorService executorService;

    /** The HTTP client service used to send requests. */
    private CloseableHttpClient httpClient = null;

    /**
     * Prepare the http client and the executor service with configured settings.
     */
    public void init() {
        try {
            ...
            this.requestExecutionService = new FutureRequestExecutionService(this.httpClient, definedExecutorService);
    ...
    /**
     * Return the {@link FutureRequestExecutionService} built by the {{@link #init()} method.
     *
     * @return the executor service to work with.
     */
    public FutureRequestExecutionService getRequestExecutionService() {
        return this.requestExecutionService;
    }

    /**
     * Return the {@link CloseableHttpClient} built by the {{@link #init()} method.
     *
     * @return the HTTP client to work with.
     */
