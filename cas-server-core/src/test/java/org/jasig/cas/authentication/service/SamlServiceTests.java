...
import org.jasig.cas.authentication.service.Response.ResponseType;
...
public class SamlServiceTests extends TestCase {
    ...
    public void testResponse() {
        ...
        Assert.assertTrue(response.getUrl().contains("SAMLart="));
    }
    ...
    public void testResponseWithNoTicket() {
        ...
        Assert.assertNotNull(response);
        assertEquals(ResponseType.REDIRECT, response.getResponseType());
        Assert.assertFalse(response.getUrl().contains("SAMLart="));
    }
