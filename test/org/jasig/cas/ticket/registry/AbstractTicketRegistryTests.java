...
public abstract class AbstractTicketRegistryTests extends TestCase {
    ...
    /**
     * Abstract method to retrieve a new ticket registry. Implementing classes return the TicketRegistry they wish to test.
     * 
    ...
    /**
     * Method to add a null to the ticket cache. This should cause an illegal state exception.
     */
    ...
    /**
     * Method to add a TicketGrantingTicket to the ticket cache. This should add the ticket and return. Failure upon any exception.
     */
    public void testAddTicketToCache() {
        try {
            this.ticketRegistry.addTicket(new TicketGrantingTicketImpl("TEST", new ImmutableAuthentication(new UsernamePasswordCredentials(),
    ...
    public void testGetTicketsFromRegistryEqualToTicketsAdded() {
        ...
        for (int i = 0; i < TICKETS_IN_REGISTRY; i++) {
            final TicketGrantingTicket ticketGrantingTicket = new TicketGrantingTicketImpl("TEST" + i, new ImmutableAuthentication(
                new UsernamePasswordCredentials(), new SimplePrincipal("test"), null), new NeverExpiresExpirationPolicy(),
                new DefaultUniqueTicketIdGenerator(), new NeverExpiresExpirationPolicy());
        ...
        try {
            ...
            for (Iterator iter = tickets.iterator(); iter.hasNext();) {
                final TicketGrantingTicket ticket = (TicketGrantingTicket)iter.next();
