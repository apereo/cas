...
public interface OperationCallback {
    ...
    /**
     * Get called by LdapTemplate.execute with an active DirContext. Do not need
     * to care about getting an active context nor releasing it.
     * 
     * @param context active context
     * @return a return object, or null
     * @throws NamingException if thrown by a ldap operation, to be auto
     * converted (TODO: with a customisable translater or fixed one ?)
