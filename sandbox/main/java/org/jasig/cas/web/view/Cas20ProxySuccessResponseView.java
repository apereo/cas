...
/**
 * <p>CAS 2.0 proxy success response view, implemented in XMLBeans.</p>
 * 
 * @author Drew Mazurek
 * @version $Revision$ $Date$
 * @since 3.0.1
 */
public class Cas20ProxySuccessResponseView extends
	...
	public final void render(final Map model, 
		...
		final ProxySuccessType proxySuccess = 
			serviceResponse.addNewProxySuccess();
