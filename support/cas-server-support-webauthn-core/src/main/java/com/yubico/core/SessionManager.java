...
public interface SessionManager {
    ...
    ByteArray createSession(
        @NonNull
        final ByteArray paramByteArray) throws ExecutionException;

    Optional<ByteArray> getSession(
        @NonNull
        final ByteArray paramByteArray);

    default boolean isSessionForUser(
        @NonNull
        final ByteArray claimedUserHandle,
        @NonNull
    ...
    default boolean isSessionForUser(
        ...
        final ByteArray claimedUserHandle,
        @NonNull
        final Optional<ByteArray> token) {
