...
import org.apereo.cas.couchdb.CouchDbSurrogateAuthorization;
...
public class SurrogateCouchDbAuthenticationTests extends BaseSurrogateAuthenticationServiceTests {
    ...
    @Autowired
    @Qualifier("surrogateCouchDbConnector")
    private CouchDbConnector couchDbConnector;

    @Autowired
    @Qualifier("surrogateCouchDbInstance")
    ...
    public void setUp() {
        ...
        repository.add(new CouchDbSurrogateAuthorization("casuser", "banderson"));
    }
