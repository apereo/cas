...
public class OpenIdValidateController extends AbstractServiceValidateController {
    ...
    public OpenIdValidateController(final ValidationSpecification validationSpecification, 
                                    ...
                                    final View failureView, final String authnContextAttribute, final ServerManager serverManager) {
        super(validationSpecification, authenticationSystemSupport, servicesManager, 
                centralAuthenticationService, proxyHandler, argumentExtractor, multifactorTriggerSelectionStrategy, 
                authenticationContextValidator, jsonView, successView, failureView, authnContextAttribute);
