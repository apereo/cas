...
@Slf4j
@Configuration(value = "CouchDbSamlIdPMetadataConfiguration", proxyBeanMethods = false)
@ConditionalOnCasFeatureModule(feature = CasFeatureModule.FeatureCatalog.SamlIdPMetadata, module = "couch-db")
