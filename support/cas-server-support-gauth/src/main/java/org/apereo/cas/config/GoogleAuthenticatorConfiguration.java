...
public class GoogleAuthenticatorConfiguration {
    ...
    public AuthenticationHandler googleAuthenticatorAuthenticationHandler() {
        ...
        final GoogleAuthenticatorAuthenticationHandler h = new GoogleAuthenticatorAuthenticationHandler(name, servicesManager, googleAuthenticatorInstance(), googleAuthenticatorTokenRepository);
