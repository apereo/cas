...
public class ForgotUsernameCaptchaWebflowConfigurerTests extends BaseWebflowConfigurerTests {
    ...
    public void verifyOperation() {
        ...
        assertNotNull(flow);
        val state = (TransitionableState) flow.getState(CasWebflowConstants.STATE_ID_SEND_FORGOT_USERNAME_INSTRUCTIONS);
        assertEquals(CasWebflowConstants.VIEW_ID_FORGOT_USERNAME_ACCT_INFO,
