...
public class QueryDatabaseAuthenticationHandlerTests {
    ...
    public void verifyAuthenticationFailsToFindUser() throws Exception {
        final QueryDatabaseAuthenticationHandler q = new QueryDatabaseAuthenticationHandler("", null, this.dataSource, SQL, PASSWORD_FIELD, null, null,
    ...
    public void verifyPasswordInvalid() throws Exception {
        final QueryDatabaseAuthenticationHandler q = new QueryDatabaseAuthenticationHandler("", null, this.dataSource, SQL, PASSWORD_FIELD,
    ...
    public void verifyBadQuery() throws Exception {
        final QueryDatabaseAuthenticationHandler q = new QueryDatabaseAuthenticationHandler("", null, this.dataSource, SQL.replace("*", "error"),
    ...
    public void verifyFindUserAndExpired() throws Exception {
        final QueryDatabaseAuthenticationHandler q = new QueryDatabaseAuthenticationHandler("", null, this.dataSource, SQL, PASSWORD_FIELD, "expired", null,
                Collections.emptyMap());
