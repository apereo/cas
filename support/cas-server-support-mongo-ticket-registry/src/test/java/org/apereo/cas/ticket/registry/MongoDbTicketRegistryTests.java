...
public class MongoDbTicketRegistryTests extends BaseTicketRegistryTests {
    ...
    public void verifyBadTicketInCatalog() {
        ...
        val mongoDbTicketRegistryTemplate = new MongoDbConnectionFactory(casSslContext.getSslContext()).buildMongoTemplate(casProperties.getTicket().getRegistry().getMongo());
