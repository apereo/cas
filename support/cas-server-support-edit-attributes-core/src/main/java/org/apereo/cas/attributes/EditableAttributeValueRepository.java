...
public interface EditableAttributeValueRepository extends Serializable {
     ...
     *            the credential
     * @param attributeIds
     *            list of attribute ids to fetch
     * @return list of attributes and the associated principal.
     */
    Pair<Principal, Map<String, String>> getAttributeValues(RequestContext requestContext, Credential credential,
     ...
     *            map of key value pairs of attributes to store
     * @return true if choice was saved.
     */
    boolean storeAttributeValues(RequestContext requestContext, Credential credential,
