...
public class FortressAuthenticationConfiguration {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(FortressAuthenticationConfiguration.class);
  ...
  public Collection<AuthenticationHandler> fortressAuthenticationHandler() {
    ...
    handlers.add(new FortressAuthenticationHandler(casProperties.getFortressProperties().getName(),
  ...
  @EnableConfigurationProperties(CasConfigurationProperties.class)
  public class FortressAuthenticationEventExecutionPlanConfiguration implements AuthenticationEventExecutionPlanConfigurer {
    @Override
