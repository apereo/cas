...
public class SamlIdPTicketCatalogConfiguration extends BaseTicketCatalogConfigurer {
    ...
    public void configureTicketCatalog(final TicketCatalog plan) {
        ...
        buildAndRegisterSamlAttributeQueryDefinition(plan, buildTicketDefinition(plan, SamlAttributeQueryTicket.PREFIX, SamlArtifactTicketImpl.class, Ordered.HIGHEST_PRECEDENCE));
    }
