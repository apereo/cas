...
@Slf4j
public class IgniteTicketRegistryWithoutEncryptionTests extends AbstractTicketRegistryTests {

    @Autowired
    @Qualifier("ticketRegistry")
    private TicketRegistry ticketRegistry;

    public IgniteTicketRegistryWithoutEncryptionTests(final boolean useEncryption) {
        super(useEncryption);
    }
