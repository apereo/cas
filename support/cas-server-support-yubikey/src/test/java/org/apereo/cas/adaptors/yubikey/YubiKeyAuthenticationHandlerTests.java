...
public class YubiKeyAuthenticationHandlerTests {
    ...
    public void checkAccountNotFound() {
        val registry = new PermissiveYubiKeyAccountRegistry(new LinkedMultiValueMap<>(),
    ...
    public void checkEncryptedAccount() {
        val registry = new PermissiveYubiKeyAccountRegistry(new LinkedMultiValueMap<>(), (uid, token) -> true);
