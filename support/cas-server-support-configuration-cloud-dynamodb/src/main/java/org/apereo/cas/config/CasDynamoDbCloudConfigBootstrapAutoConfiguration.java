...
@AutoConfiguration
public class CasDynamoDbCloudConfigBootstrapAutoConfiguration implements PropertySourceLocator {
    ...
    public PropertySource<?> locate(final Environment environment) {
        ...
        try {
            ...
            result.items()
                .stream()
                .map(CasDynamoDbCloudConfigBootstrapAutoConfiguration::retrieveSetting)
