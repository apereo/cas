...
/**
 * This is {@link OAuth20CallbackUrlBuilder} that attempts to build the callback url
 ...
 * @since 5.2.0
 */
public interface OAuth20CallbackUrlBuilder {
     ...
     * @return the string
     */
    String build(J2EContext context,
                 String clientId,
