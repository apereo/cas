...
public class OAuth20AccessTokenControllerTests extends AbstractOAuth20Tests {
    ...
    public void verifyClientNoClientId() throws Exception {
        ...
        mockRequest.setParameter(OAuthConstants.GRANT_TYPE, OAuthGrantTypes.AUTHORIZATION_CODE.name().toLowerCase());
    ...
    public void verifyUserNoClientId() throws Exception {
        ...
        final MockHttpServletRequest mockRequest = new MockHttpServletRequest("GET", CONTEXT
                + OAuthConstants.ACCESS_TOKEN_URL);
        mockRequest.setParameter(OAuthConstants.GRANT_TYPE, OAuthGrantTypes.PASSWORD.name().toLowerCase());
    ...
    public void verifyRefreshTokenExpiredToken() throws Exception {
        ...
        final MockHttpServletRequest mockRequest = new MockHttpServletRequest("GET", CONTEXT
                + OAuthConstants.ACCESS_TOKEN_URL);
        mockRequest.setParameter(OAuthConstants.GRANT_TYPE, OAuthGrantTypes.REFRESH_TOKEN.name().toLowerCase());
        mockRequest.setParameter(OAuthConstants.CLIENT_ID, CLIENT_ID);
        mockRequest.setParameter(OAuthConstants.CLIENT_SECRET, CLIENT_SECRET);
