...
@TestPropertySource(properties = {
    ...
    "cas.ticket.registry.jpa.url=jdbc:mysql://localhost:3306/cas_ticket_cleaner?allowPublicKeyRetrieval=true&characterEncoding=UTF-8&useSSL=FALSE&createDatabaseIfNotExist=true",
