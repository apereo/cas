...
public class JcifsSpnegoAuthenticationHandler extends AbstractPreAndPostProcessingAuthenticationHandler {
    ...
    public JcifsSpnegoAuthenticationHandler(final String name, final Authentication authentication, final boolean principalWithDomainName,
                                            final boolean isNTLMallowed) {
        super(name);
