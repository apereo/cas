...
public class JcifsSpnegoAuthenticationHandlerTests {
    ...
    public void verifySuccessfulAuthenticationWithDomainName() throws Exception {
        ...
        final AuthenticationHandler authenticationHandler = new JcifsSpnegoAuthenticationHandler("", null, new MockJcifsAuthentication(true), true, true);
    ...
    public void verifySuccessfulAuthenticationWithoutDomainName() throws Exception {
        final SpnegoCredential credentials = new SpnegoCredential(new byte[] {0, 1, 2});
        final AuthenticationHandler authenticationHandler = new JcifsSpnegoAuthenticationHandler("", null, new MockJcifsAuthentication(true), false, true);
        assertNotNull(authenticationHandler.authenticate(credentials));
        assertEquals("test", credentials.getPrincipal().getId());
        assertNotNull(credentials.getNextToken());
    }
    ...
    public void verifyUnsuccessfulAuthentication() throws Exception {
        final SpnegoCredential credentials = new SpnegoCredential(new byte[] {0, 1, 2});
        final AuthenticationHandler authenticationHandler = new JcifsSpnegoAuthenticationHandler("", null, new MockJcifsAuthentication(false), true, true);
    ...
    public void verifyGetSimpleCredentials() {
        ...
        final JcifsSpnegoAuthenticationHandler authenticationHandler = new JcifsSpnegoAuthenticationHandler("", null, new MockJcifsAuthentication(true), true, true);
        ...
        final JcifsSpnegoAuthenticationHandler handlerNoDomain = new JcifsSpnegoAuthenticationHandler("", null, new MockJcifsAuthentication(true), false, true);
