...
/**
 * This is {@link JdbcEditableAttributeValueRepository}.
 * Stores editable attributes inside an the jdbc instance.
 *
...
public class JdbcEditableAttributeValueRepository extends AbstractPrincipalEditableAttributeValueRepository {
	...
	public boolean storeAttributeValues(RequestContext requestContext, Credential credential,
		...
		Pair<String,List<String>> sqlParams = generateUpdateSql(tableName, credential.getId(), attributeValues);
		try {
	...
	static Pair<String,List<String>> generateUpdateSql(String tableName, String username, Map<String, String> attributeValues) {
