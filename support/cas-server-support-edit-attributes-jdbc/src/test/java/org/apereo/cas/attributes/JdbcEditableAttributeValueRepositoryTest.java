...
public class JdbcEditableAttributeValueRepositoryTest {
    ...
    public void testGenerateUpdateSql() {
        ...
        Pair<String, List<String>> result = JdbcEditableAttributeValueRepository.generateUpdateSql("someTable",
                "dbUser", t1);

        assertEquals(a1, result.getRight());
        assertEquals(s1, result.getLeft());
        ...
        assertEquals(a2, result.getRight());
        assertEquals(s2, result.getLeft());
