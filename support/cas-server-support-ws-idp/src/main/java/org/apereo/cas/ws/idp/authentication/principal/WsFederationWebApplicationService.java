...
@NoArgsConstructor
public class WsFederationWebApplicationService extends AbstractWebApplicationService {
     ...
     */
    @JsonCreator
    protected WsFederationWebApplicationService(@JsonProperty("id") final String id,
