...
public class GoogleSaml20ObjectBuilderTests extends AbstractOpenSamlTests {
    ...
    private static final String SAML_AUTHN_REQUEST = """
        <?xml version="1.0" encoding="UTF-8"?>\r
        <samlp:AuthnRequest xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" ID="koppjkmemdcahpgfgcgelhncepikbjcbiiopooif" Version="2.0" IssueInstant="2018-12-13T18:32:28Z" ProtocolBinding="urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST" ProviderName="google.com" IsPassive="false" AssertionConsumerServiceURL="https://www.google.com/a/gtest.miamioh.edu/acs"><saml:Issuer xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion">google.com</saml:Issuer><samlp:NameIDPolicy AllowCreate="true" Format="urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified" /></samlp:AuthnRequest>\r
        """;
