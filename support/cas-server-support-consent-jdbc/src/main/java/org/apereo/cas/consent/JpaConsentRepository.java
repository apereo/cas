...
public class JpaConsentRepository extends BaseConsentRepository implements DisposableBean {
    ...
    private static final String ENTITY_NAME = ConsentDecision.class.getSimpleName();
    ...
    public @Nullable ConsentDecision findConsentDecision(final Service service,
        ...
        return transactionTemplate.execute(_ -> {
            try {
                ...
                return entityManager.createQuery(query, ConsentDecision.class)
    ...
    public Collection<? extends ConsentDecision> findConsentDecisions() {
        return transactionTemplate.execute(_ -> entityManager.createQuery(SELECT_QUERY, ConsentDecision.class).getResultList());
    }

    @Override
    public ConsentDecision storeConsentDecision(final ConsentDecision decision) {
        return transactionTemplate.execute(_ -> {
            val account = ObjectUtils.getIfNull(entityManager.find(ConsentDecision.class, decision.getId()), new ConsentDecision());
