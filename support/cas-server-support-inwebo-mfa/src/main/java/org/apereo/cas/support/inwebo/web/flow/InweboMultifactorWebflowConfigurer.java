...
public class InweboMultifactorWebflowConfigurer extends AbstractCasMultifactorWebflowConfigurer {
    ...
    protected void doInitialize() {
        multifactorAuthenticationFlowDefinitionRegistries.forEach(registry -> {
            ...
            val checkUserState = createActionState(flow, "checkUser", createEvaluateAction("inweboCheckUserAction"));
            ...
            val mustEnrollState = createActionState(flow, "mustEnroll", createEvaluateAction("inweboMustEnrollAction"));
            createTransitionForState(mustEnrollState, CasWebflowConstants.TRANSITION_ID_SUCCESS, "inweboError");

            val startPushState = createActionState(flow, "startPush", createEvaluateAction("inweboPushAuthenticateAction"));
            ...
            val realSubmitState = createActionState(flow, CasWebflowConstants.STATE_ID_REAL_SUBMIT, createEvaluateAction("inweboCheckAuthenticationAction"));
