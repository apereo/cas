...
public class ShiroAuthenticationHandlerTests {
    ...
    public void checkAuthenticationSuccessful() throws Exception {
        final ShiroAuthenticationHandler shiro = new ShiroAuthenticationHandler("", null, Collections.emptySet(), Collections.emptySet());
    ...
    public void checkAuthenticationSuccessfulRolesAndPermissions() throws Exception {
        final ShiroAuthenticationHandler shiro = new ShiroAuthenticationHandler("", null, Collections.singleton("admin"),
    ...
    public void checkAuthenticationSuccessfulMissingRole() throws Exception {
        final ShiroAuthenticationHandler shiro = new ShiroAuthenticationHandler("", null, Collections.singleton("student"), Collections.emptySet());
        shiro.loadShiroConfiguration(new ClassPathResource("shiro.ini"));
    ...
    public void checkAuthenticationSuccessfulMissingPermission() throws Exception {
        final ShiroAuthenticationHandler shiro = new ShiroAuthenticationHandler("", null, Collections.emptySet(), Collections.singleton("dosomething"));
        shiro.loadShiroConfiguration(new ClassPathResource("shiro.ini"));
