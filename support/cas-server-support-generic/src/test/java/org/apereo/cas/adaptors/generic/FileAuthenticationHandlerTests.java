...
public class FileAuthenticationHandlerTests {
    ...
    public void setUp() throws Exception {
        this.authenticationHandler = new FileAuthenticationHandler("", null, new ClassPathResource("authentication.txt"),
    ...
    public void verifyAuthenticatesUserInFileWithCommaSeparator() throws Exception {
        final UsernamePasswordCredential c = new UsernamePasswordCredential();
        this.authenticationHandler = new FileAuthenticationHandler("", null, new ClassPathResource("authentication2.txt"), ",");
        c.setUsername("scott");
        c.setPassword("rutgers");
        assertNotNull(this.authenticationHandler.authenticate(c));
    }
    ...
    public void verifyAuthenticateNoFileName() throws Exception {
        final UsernamePasswordCredential c = new UsernamePasswordCredential();
        this.authenticationHandler = new FileAuthenticationHandler("", null, new ClassPathResource("fff"), FileAuthenticationHandler.DEFAULT_SEPARATOR);
