...
@Import({
    ...
    BaseMemcachedTicketRegistryTests.MemcachedTicketRegistryTestConfiguration.class
})
@TestPropertySource(
    properties = {
...
@Getter
@Deprecated(since = "7.0.0")
abstract class BaseMemcachedTicketRegistryTests extends BaseTicketRegistryTests {
    @Autowired
