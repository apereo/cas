...
/**
 * Handles tests for {@link JpaServiceRegistry} via CouchDB.
 *
 * @author Timur Duehr
 * @since 6.0.0
 */
...
@SpringBootTest(classes = {
    ...
    CouchDBJpaServiceRegistryTests.TimeAwareServicesManagerConfiguration.class,
...
@Slf4j
public class CouchDBJpaServiceRegistryTests extends JpaServiceRegistryTests {
}
