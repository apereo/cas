...
/**
 * This is {@link DefaultConsentActivationStrategyTests}.
 *
...
@Tag("Simple")
public class DefaultConsentActivationStrategyTests {
    @Autowired
    ...
    public void verifyConsentActive() {
        ...
        assertTrue(consentActivationStrategy.isConsentRequired(service, registeredService,
    ...
    public void verifyConsentDisabled() {
        ...
        val service = CoreAuthenticationTestUtils.getWebApplicationService(registeredService.getServiceId());
        assertFalse(consentActivationStrategy.isConsentRequired(service, registeredService,
            CoreAuthenticationTestUtils.getAuthentication(), context));
    }
