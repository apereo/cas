...
/**
 * This is {@link CasOidcMongoDbJwksConfiguration}.
 *
 * @author Misagh Moayyed
 * @since 8.0.0
 */
@EnableConfigurationProperties(CasConfigurationProperties.class)
@ConditionalOnFeatureEnabled(feature = CasFeatureModule.FeatureCatalog.OpenIDConnect, module = "jwks-mongodb")
@Configuration(value = "CasOidcMongoDbJwksConfiguration", proxyBeanMethods = false)
class CasOidcMongoDbJwksConfiguration {
