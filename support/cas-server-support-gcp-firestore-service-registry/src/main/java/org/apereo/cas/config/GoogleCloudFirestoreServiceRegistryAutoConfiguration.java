...
/**
 * This is {@link GoogleCloudFirestoreServiceRegistryAutoConfiguration}.
 *
...
@EnableScheduling
@ConditionalOnFeatureEnabled(feature = CasFeatureModule.FeatureCatalog.ServiceRegistry, module = "gcp")
@AutoConfiguration
public class GoogleCloudFirestoreServiceRegistryAutoConfiguration {
    @Bean
