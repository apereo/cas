...
public class CasMongoAuthenticationConfiguration {
    ...
    public AuthenticationHandler mongoAuthenticationHandler() {
        ...
        final MongoAuthenticationHandler handler = new MongoAuthenticationHandler(mongo.getName(), servicesManager, 
                mongo.getCollectionName(), mongo.getMongoHostUri(),
                mongo.getAttributes(), mongo.getUsernameAttribute(), 
                mongo.getPasswordAttribute(), mongoPasswordEncoder);
