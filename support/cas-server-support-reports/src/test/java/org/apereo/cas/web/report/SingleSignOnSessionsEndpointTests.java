...
public class SingleSignOnSessionsEndpointTests extends AbstractCasEndpointTests {
    ...
    public void verifyOperation() {
        var results = singleSignOnSessionsEndpoint.getSsoSessions(SingleSignOnSessionsEndpoint.SsoSessionReportOptions.ALL.getType(), null);
        assertFalse(results.isEmpty());
    ...
    public void verifyDirect() {
        ...
        tgt.setProxiedBy(CoreAuthenticationTestUtils.getWebApplicationService());
        centralAuthenticationService.addTicket(tgt);
        var results = singleSignOnSessionsEndpoint.getSsoSessions(SingleSignOnSessionsEndpoint.SsoSessionReportOptions.DIRECT.getType(), null);
        assertFalse(results.isEmpty());
        results = singleSignOnSessionsEndpoint.getSsoSessions(null, null);
        assertFalse(results.isEmpty());
    }
    ...
    public void verifyDeleteFails() {
        ...
        val results = new SingleSignOnSessionsEndpoint(cas, casProperties, mock(LogoutManager.class)).destroySsoSessions(
