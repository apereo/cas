...
public class PersonDirectoryEndpoint extends BaseCasMvcEndpoint {
    ...
    public Map<String, Object> releasePrincipalAttributes(@RequestParam final String username,
        ...
        final var attributesToRelease = registeredService.getAttributeReleasePolicy()
        ...
        var copy = renderViewAndGetResult(this.cas1ServiceSuccessView, model, request, response).getKey().getCopy();
    ...
    private Pair<CopyPrintWriter, CopyServletOutputStream> renderViewAndGetResult(final View view,
                                                                                  ...
                                                                                  final HttpServletRequest request,
                                                                                  final HttpServletResponse response) throws Exception {
        final var writer = new CopyPrintWriter();
        final var stream = new CopyServletOutputStream(response.getOutputStream());
