...
public class CibaPushTokenDeliveryHandler implements CibaTokenDeliveryHandler {
    ...
    @Override
    public boolean supports(final OidcRegisteredService registeredService) {
        return StringUtils.equalsIgnoreCase(registeredService.getBackchannelTokenDeliveryMode(), deliveryMode.getMode());
    }
}
