...
public class StringableCipherExecutorCommand {
    ...
    public void cipher(
        ...
        @ShellOption(value = {"encryption-key-size"}, defaultValue = "" + CipherExecutor.DEFAULT_STRINGABLE_ENCRYPTION_KEY_SIZE, help = "Encryption key size")
        final int secretKeyEncryptionSize,
        @ShellOption(value = {"signing-key-size"}, defaultValue = "" + CipherExecutor.DEFAULT_STRINGABLE_SIGNING_KEY_SIZE, help = "Signing key size")
