...
printgreen "Uploading SAML service provider metadata to ${BASE_URL}/JpaSamlRegisteredServiceMetadataResolver"
curl -k -fsS -X POST "${BASE_URL}/JpaSamlRegisteredServiceMetadataResolver" \
