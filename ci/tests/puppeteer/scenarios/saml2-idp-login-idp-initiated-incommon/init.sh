...
curl -k --retry 5 --retry-delay 2 --retry-connrefused --max-time 30 -L https://mdq.incommon.org/certs/inc-md-cert-mdq.pem -o "${SCENARIO_FOLDER}/saml-md/inc-md-cert-mdq.pem"
