...
decrypt-value --value {cas-cipher}Snynjp9UvY1VohHy+L5ig9ydKUw/E3yaEsWsxmS1eiQwxwJMPtjpuCNPaBOyPhQs --password JASTYPTPW --alg PBEWITHSHAAND256BITAES-CBC-BC --provider BC
