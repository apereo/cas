...
echo "Creating CSF Dir conn instance"
curl -X 'POST' \
  ...
  "errored": false,
  "adminRealm": "/",
  "location": "file:/var/lib/apache-syncope/bundles/",
...
curl -X 'POST' \
  ...
  "provisions": [
    {
      "key": "75a3f78b-6b6d-4c4e-a3f7-8b6b6dcc4e54",
      "anyType": "USER",
...
curl -X 'POST' \
  ...
  -H 'Content-Type: application/json' \
  -d '  {
    "@class": "org.apache.syncope.common.lib.to.VirSchemaTO",
    "key": "toBeVirtualized",
    "labels": {},
    "readonly": false,
    "resource": "import",
...
curl -X 'POST' \
  ...
  -H 'Content-Type: application/json' \
  -d '{
    "@class": "org.apache.syncope.common.lib.to.DerSchemaTO",
    "key": "description",
