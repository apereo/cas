...
# Note that host.k3d.internal also has to resolve inside the cluster
# k3d should make an entry in the coredns configmap when cluster is created but
# if it goes away you might have to re-create cluster or edit the configmap to add it back
