...
if [[ $cloneRepository == "true" ]]; then
  ...
  mv "$PWD/docs-latest/_layout" "$PWD/docs-layout"
  ...
  rm -Rf "$PWD/gh-pages/_layout/$branchVersion" >/dev/null
