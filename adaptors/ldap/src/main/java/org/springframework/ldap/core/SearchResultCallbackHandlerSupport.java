...
/**
 * SearchResultCallbackHandler implementation helper, providing a default implementation of getResult so that only the processSearchResult has to be
 * focused on
 * 
...
public abstract class SearchResultCallbackHandlerSupport implements
     ...
     * 
     * @see org.springframework.ldap.core.SearchResultCallbackHandler#getResult()
     */
