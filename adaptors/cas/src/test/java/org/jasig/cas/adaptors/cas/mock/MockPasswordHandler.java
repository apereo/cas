 ...
 */
public class MockPasswordHandler 
    ...
    public boolean authenticate(ServletRequest requestArg, String usernameArg, String passwordArg) {
    ...
    /**
     * Return the value this object will return on invocation of its interface method.
    ...
    /**
     * Set the value this object will return on invocation of its interface method.
