...
public class SmartOpenIdControllerTest extends TestCase {
    ...
    public void setUp() {
        ...
        this.smartOpenIdController.setServerManager(this.manager);
    }

    public void testCanHandle() {
        this.request.addParameter("openid.mode", "associate");
        final boolean canHandle = this.smartOpenIdController.canHandle(this.request, this.response);
    ...
    public void testGetAssociationResponse() {
        ...
        final Map<String, String> assocResponse = this.smartOpenIdController.getAssociationResponse(this.request);
