...
import org.jasig.cas.web.support.NhnLegacyAuthenticationMediator;
 ...
 * @since 3.0.0.4
 */
public class NhnAuthenticationViaFormAction {
    ...
    /** for Legacy SSO **/
    @Value("${legacy.authUrl}")
    private String legacyAuthUrl;
    @Value("${legacy.targetUrl}")
    private String legacyTargetUrl;
    @Value("${legacy.agentName}")
    private String legacyAgentName;
    @Value("${legacy.server.isSelfSigned}")
