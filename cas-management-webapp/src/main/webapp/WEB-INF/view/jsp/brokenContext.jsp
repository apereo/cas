...
<jsp:directive.include file="default/ui/includes/top.jsp" />
	<div id="welcome">
			...
			<p>
			  There was a fatal error initializing the CAS Management application context.  This is almost always because of an error in the Spring bean configuration files.
