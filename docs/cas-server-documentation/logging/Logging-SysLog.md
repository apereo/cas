...
<div class="alert alert-warning">
  <strong>Pay Attention</strong><br /> [Mapped Diagnostic Context](Logging-MDC.html) (`MDC`) may contain the password. Setting `includeMDC=true` sends clear password as variable to syslog.
</div>
