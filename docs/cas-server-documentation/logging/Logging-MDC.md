...
<div class="alert alert-warning">
  <strong>Pay Attention</strong><br /> These variables potentially include the password. If you set `includeMDC=true` in <a href="Logging-Syslog.html">syslog appender</a>, these informations, including clear password, will be sent to syslog.
</div>
