...
The overlay projects backed and generated by the CAS Initializr are now put into a ready-made git repository. Furthermore, the metadata for the CAS Initializr is now updated to support version compatibility ranges. This would come handy to indicate the relationship between a CAS module and a CAS version.
