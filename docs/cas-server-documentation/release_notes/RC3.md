...
- [Bootstrap libraries](../ux/User-Interface-Customization-ThemeCollections.html) are pulled out of the default CAS web application and are moved into their own module. This is done to reduce the size of the CAS web application and make it easier to modularize the codebase.
