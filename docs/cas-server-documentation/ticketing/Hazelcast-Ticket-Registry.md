...
{% include {{ version }}/hazelcast-ticket-registry-configuration.md %}

{% include {{ version }}/signing-encryption-configuration.md configKey="cas.ticket.registry.hazelcast" signingKeySize="512" encryptionKeySize="16" encryptionAlg="AES" %}
