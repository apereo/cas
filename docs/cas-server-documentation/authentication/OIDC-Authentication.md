...
| `/oidc/oidcPushAuthorize`                | Pushed authorization requests are handled here. |
...
| `/oidc/list`                             | [For a trust anchor or intermediate in a federation](OIDC-Authentication-Federation.html), it returns the list of the subordinates. |
