        ...
        *   [SAML2](#saml2authn)
            ...
            *   [Service Providers](#saml2spoverview)
                ...
                *   [Metadata Management](#samlmdmgmt)
                    *   [Overview](/cas/{{ version }}/services/SAML2-Service-Management-Metadata.html)
                    *   [MDQ](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-MDQ.html)
                    *   [HTTP](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-HTTP.html)
                    *   [REST](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-REST.html)
                    *   [Git](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-Git.html)
                    *   [MongoDb](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-MongoDb.html)
                    *   [Redis](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-Redis.html)
                    *   [JPA](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-JPA.html)
                    *   [Groovy](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-Groovy.html)
                    *   [Amazon S3](/cas/{{ version }}/services/Configuring-SAML2-DynamicMetadata-AmazonS3.html)
