...
/**
 * Interface to provide a standard way to translate a plaintext password into a different representation of that password so that the password may be
 * compared with the stored encrypted password without having to decode the encrypted password.
 * 
