...
/**
 * Default implementation of AuthenticationManager. Default implementation accepts
 * a list of handlers.  It will iterate through the list of handlers and return the
 * principal for the first one that can validate the request.
 * 
