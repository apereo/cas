...
/**
 * Class that if provided a query that returns a password (paramater of query must be username) will compare that
 * password to a translated version of the password provided by the user.  If they match, then authentication
 * succeeds.  Default password translator is plaintext translator.
 * 
 * Note that this class provides failover if provided multiple datasources. On DataAccessResourceFailureException,
 * the next datasource will be tried.
 * 
