...
/**
 * Interface for the handlers that validate credentials for authentication. Developers deploying CAS supply an AuthenticationHandler and plug it into
 * the AuthenticationManager. Implementations of this interface might be backed by such things as LDAP servers, Kerberos realms, RDBMS tables, etc.
 * 
