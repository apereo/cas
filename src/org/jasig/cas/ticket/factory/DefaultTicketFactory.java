...
/**
 * Factory to create new tickets. It works by allowing the user to register a list of ticket creators. The factory will
 * attempt to match the class requested with a <i>creator</i> and then delegate the work to that <i>creator</i>.
 * 
