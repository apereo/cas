...
/**
 * Factory strategy that is responsible for creating "immutable view" of the Ticket 
 * and its sub-types by wrapping the internal implementation of a Ticket in 
 * the "protective proxy".
 * <p>
 * Typical implementation might for example use JDK 1.3+ dynamic proxy or SpringAOP 
 * proxy built on top of JDK dynamic
 * proxy.
 * <p>
