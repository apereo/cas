...
/**
 * Interface for the management of tickets. All ticket creation, validation and deletion happens through the manager. The manager is in charge of
 * maintaining the registry of tickets. Ticket Validation currently constitutes a "use" of a ticket and the state will be updating accordingly.
 * 
...
public interface TicketManager {
    ...
    /**
     * Method to retrieve a ticket from the registry, validate it for the request, check its expiration and if it passes, return the ticket. Otherwise
     * return null.
     * 
