 ...
 * return types and parameter types for each method. It is currently designed to ignore any java.* or javax.* class. It also assumes that the types
 * are JavaBeans. It does not actually check. A more sophisticated version would be able to check if a class was a valid JavaBean and only register
 * valid JavaBeans.
 * 
