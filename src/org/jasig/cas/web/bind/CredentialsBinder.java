...
/**
 * Interface for a class that can bind items stored in the request to a particular credentials implementation. This allows for binding beyond the
 * basic JavaBean/Request parameter binding that is handled by Spring automatically.
 * 
...
public interface CredentialsBinder {
    ...
    /**
     * Method to allow manually binding attributes from the request object to properties of the credentials. Useful when there is no mapping of
