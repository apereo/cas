...
public enum CasLabels {
    ...
    LABEL_DELEGATED_AUTHENTICATION_PAC4J("Delegated Authentication Pac4J", "delegating\\s|pac4j|delegation|delegated authentication|delegated auth|delegated client|IdP discovery"),
