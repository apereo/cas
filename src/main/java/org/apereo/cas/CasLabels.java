...
public enum CasLabels {
    ...
    LABEL_DEPENDENCIES_MODULES("Dependencies & Modules", "gradle|dependency|bom|maven|dependencies|\\bversion\\b|upgrade|update.+to\\sv.+"),
    LABEL_DIGEST_AUTHENTICATION("Digest Authentication"),
    LABEL_DOCUMENTATION("Documentation", "docs|markdown|gh-pages|doc\\s+"),
    ...
    LABEL_LDAP_ACTIVE_DIRECTORY("LDAP & Active Directory", "passivator|ldap|\\bad\\b"),
    ...
    LABEL_MONITORING("Monitoring", "healthcheck|status|@DeleteOperation|@ReadOperation|@WriteOperation|HealthIndicator|monitors"),
    LABEL_OAUTH2_PROTOCOL("OAuth2 Protocol", "oauth|client_id|client_secret|pkce"),
    LABEL_OPENID_CONNECT_PROTOCOL("OpenID Connect Protocol", "oidc|idtoken|client_id|client_secret|pkce|openid\\sconnect"),
