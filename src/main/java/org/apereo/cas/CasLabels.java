...
public enum CasLabels {
    ...
    LABEL_AUTHENTICATION_THROTTLING("Authentication Throttling", "throttling"),
    ...
    LABEL_REST_PROTOCOL("REST Protocol & Integrations", "rest"),
    LABEL_REDIS("Redis", "redis|sentinel"),
    LABEL_REFACTORING_CODE_CLEANUP("Refactoring & Code CleanUp", "refactor:*\\s*|NPE|cleanup|CVE|spotbugs|typos|checkstyle|codacy|duplicate code"),
    ...
    LABEL_USER_INTERFACE_THEMES("User Interface & Themes", "\\bIE\\b|jquery|ux|thymeleaf|\\bhtml\\b|views|screen|page|gulp|javascript|\\bjs\\b|sass|css|themes|\\btheme\\b"),
