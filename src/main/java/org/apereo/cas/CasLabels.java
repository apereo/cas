...
public enum CasLabels {
    ...
    LABEL_PASSWORD_MANAGEMENT("Password Management", "password reset|pm"),
    ...
    LABEL_REMEMBER_ME("Remember-Me", "long-term"),
    ...
    LABEL_SERVICES_REGISTRIES("Services & Registries", "service registry|service files|services"),
    ...
    LABEL_UNIT_INTEGRATION_TESTS("Unit/Integration Tests", "\btest\b|junit|coverage|tests|mockito|suite|\bunit test\b"),
