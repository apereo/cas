...
public enum CasLabels {
    ...
    LABEL_DELEGATED_AUTHENTICATION_PAC4J("Delegated Authentication Pac4J",
        "delegate auth|delegating\\s|pac4j|delegation|delegated authentication|delegated auth|delegated client|IdP discovery"),
    ...
    LABEL_INTERNATIONALIZATION("Internationalization", "localization|localized|message bundle|translation|language bundle|I18n|french|spanish|german|italian|locale"),
    ...
    LABEL_MFA("MFA", "multifactor authentication|MFA|FailureMode|Inwebo|Webauthn"),
    ...
    LABEL_MFA_GOOGLE_AUTHENTICATOR("MFA Google Authenticator", "gauth|Google Authenticator|Google Auth|Scratch Codes"),
    ...
    LABEL_MONITORING("Monitoring", "apm|elastic|sentry|monitor|health|healthcheck|status|@(Delete|Read|Write)Operation|HealthIndicator|monitors|actuator"),
