...
public enum CasLabels {
    ...
    LABEL_MFA_GOOGLE_AUTHENTICATOR("MFA Google Authenticator"),
    LABEL_MFA_SWIVEL_SECURE("MFA Swivel Secure"),
    ...
    LABEL_SAML2_PROTOCOL("SAML2 Protocol"),
    ...
    LABEL_SPRING_CLOUD_EUREKA_DISCOVERY("Spring Cloud Eureka Discovery"),
    LABEL_SPRING_CLOUD_VAULT("Spring Cloud Vault"),
    LABEL_SPRING_CLOUD_ZIPKIN("Spring Cloud Zipkin"),
    LABEL_SPRING_WEBFLOW("Spring Webflow"),
    LABEL_STATISTICS_METRICS("Statistics & Metrics"),
    LABEL_SURROGATE_AUTHENTICATION("Surrogate Authentication"),
