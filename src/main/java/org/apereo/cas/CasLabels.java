...
public enum CasLabels {
    ...
    LABEL_AUDITS_LOGGING("Audits & Logging", "logs|log4j|audit|inspektr|logback|\\blog\\b"),
    ...
    LABEL_DEPENDENCIES_MODULES("Dependencies & Modules", "gradle|dependency|bom|maven|dependencies|version|upgrade|update\\s\\w+\\sto\\sv.+"),
    ...
    LABEL_GRADLE_BUILD_RELEASE("Gradle Build & Release", "gulp|jdk|gradle|sonatype|snapshot|dependency|module|pom|bom|travis-ci|dependencies|update\\s\\w+\\sto\\sv.+"),
    ...
    LABEL_REFACTORING_CODE_CLEANUP("Refactoring & Code CleanUp", "refactor"),
