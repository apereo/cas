 ...
 * @since 3.1
 */
public final class LDAPAttributePrincipalResolver extends AbstractLdapPersonDirectoryPrincipalResolver {

    /**
     * The PrincipalResolver that resolves the principal from the
     * request
     */
    @NotNull
    ...
    protected String extractPrincipalId(final Credential credential) {
        final Principal principal = this.principalResolver
            .resolve(credential);
    ...
    /*
     * Delegates checking to the configured PrincipalResolver.
     */
