...
public final class DefaultLdapServiceMapper extends LdapServiceMapper {
    ...
    protected RegisteredService doMapFromContext(final DirContextOperations ctx) {
        ...
        s.setEnabled(LdapUtils.getBoolean(ctx, this.serviceEnabledAttribute));
        s.setAllowedToProxy(LdapUtils.getBoolean(ctx, this.serviceAllowedToProxyAttribute));
        s.setAnonymousAccess(LdapUtils.getBoolean(ctx, this.serviceAnonymousAccessAttribute));
        s.setDescription(ctx.getStringAttribute(this.serviceDescriptionAttribute));
        s.setSsoEnabled(LdapUtils.getBoolean(ctx, this.serviceSsoEnabledAttribute));
    ...
    protected DirContextAdapter doMapToContext(final RegisteredService service,final  DirContextAdapter ctx) {
        ...
        LdapUtils.setBoolean(ctx, this.serviceEnabledAttribute, service.isEnabled());
        LdapUtils.setBoolean(ctx, this.serviceAllowedToProxyAttribute, service.isAllowedToProxy());
        LdapUtils.setBoolean(ctx, this.serviceAnonymousAccessAttribute, service.isAnonymousAccess());
        LdapUtils.setBoolean(ctx, this.serviceSsoEnabledAttribute, service.isSsoEnabled());
        ...
        if (!LdapUtils.containsObjectClass(ctx, this.objectclass))
            ctx.addAttributeValue(LdapUtils.OBJECTCLASS_ATTRIBUTE, this.objectclass);
    ...
    protected Filter getLoadFilter() {
        return new EqualsFilter(LdapUtils.OBJECTCLASS_ATTRIBUTE, this.objectclass);
    }
