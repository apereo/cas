...
import org.apereo.cas.configuration.model.support.multiphase.MultiphaseAuthenticationProperties;
...
public class AuthenticationProperties implements Serializable {
     ...
     */
    @NestedConfigurationProperty
    private MultiphaseAuthenticationProperties multiphase = new MultiphaseAuthenticationProperties();
