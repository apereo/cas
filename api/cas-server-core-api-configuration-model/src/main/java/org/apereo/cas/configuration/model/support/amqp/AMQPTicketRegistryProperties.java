package org.apereo.cas.configuration.model.support.amqp;
...
/**
 * This is {@link AMQPTicketRegistryProperties}.
 *
 * @author Misagh Moayyed
 * @since 5.2.0
 */
@RequiresModule(name = "cas-server-support-amqp-ticket-registry")
@Getter
@Setter
@Accessors(chain = true)
public class AMQPTicketRegistryProperties implements Serializable {
