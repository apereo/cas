...
//	factory(window.jQuery);
  ...
  var Renderer = function () {
    ...
    tplToolbarInfo = {
      ...
      table: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.table.table + '" data-toggle="dropdown" tabindex="-1"><i class="fa fa-table fa-sm-2x icon-table"></i></button>' +
      ...
      style: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.style.style + '" data-toggle="dropdown" tabindex="-1"><i class="fa fa-magic fa-sm icon-magic"></i></span></button>' +
               '<ul class="dropdown-menu animated flipInY">' +
      ...
      fontsize: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small" data-toggle="dropdown" title="' + lang.font.size + '" tabindex="-1"><span class="note-current-fontsize" style="letter-spacing:0px;">11</span></button>' +
               '<ul class="dropdown-menu animated flipInY">' +
      ...
      color: function (lang) {
        return '' +
               '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.color.more + '" data-toggle="dropdown" tabindex="-1">' +
      ...
      paragraph: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small" title="' + lang.paragraph.paragraph + '" data-toggle="dropdown" tabindex="-1"><i class="fa fa-align-left icon-align-left"></i></button>' +
        '<ul class="dropdown-menu animated flipInY">' +
          '<li>' +
      ...
      height: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small" data-toggle="dropdown" title="' + lang.font.height + '" tabindex="-1"><i class="fa fa-text-height icon-text-height"></i></button>' +
        '<ul class="dropdown-menu animated flipInY">' +
               ...
               '<div class="note-link-dialog modal" aria-hidden="false">' +
                 '<div class="modal-dialog animated bounceIn">' +
                   '<div class="modal-content">' +
                     ...
                     '</div>' +
                     '<div class="modal-footer">' +
                       '<button href="#" class="btn btn-primary note-link-btn">' + lang.link.insert + '</button>' +
                     '</div>' +
                   '</div>' +
                 '</div>' +
               '</div>' +
    ...
    this.createLayout = function ($holder, options) {
      ...
      //01. create Editor
      var $editor = $('<div class="note-editor tile m-b-0 col-sm-12"></div>');
      ...
      sToolbar = '<div class="note-toolbar btn-toolbar-block tile-title textAreaEditor">' + sToolbar + '</div>';
