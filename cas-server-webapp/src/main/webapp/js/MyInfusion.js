 ...
 * 
 * 1. logicalFrom() is modified to determine the position based on the direction value passed
 * 2. onMove() event is modified to be "preventable", such that callbacks can now stop the move operation by returning "false"
 */
