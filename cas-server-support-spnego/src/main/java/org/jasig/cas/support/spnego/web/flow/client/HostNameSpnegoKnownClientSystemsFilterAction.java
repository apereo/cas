 ...
 * @since 4.1
 */
public final class HostNameSpnegoKnownClientSystemsFilterAction extends BaseSpnegoKnownClientSystemsFilterAction {
    ...
    protected boolean doSpnego() {
        final String hostName = this.getRemoteHostName();
