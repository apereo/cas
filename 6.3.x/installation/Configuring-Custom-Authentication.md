...
To learn more about the registration strategy, [please see this guide](https://docs.spring.io/spring-boot/docs/current/reference/html/features.html#features).
