...
class WebApplicationServiceFactoryTests {
    ...
    void verifyServiceAttributes() {
        ...
        assertEquals(8, service.getAttributes().size());
        ...
        assertNotNull(service.getHttpRequestAttribute("fullRequestUrl", String.class));
        assertNotNull(service.getHttpRequestAttribute("requestURL", String.class));
        assertNotNull(service.getHttpRequestAttribute("localeName", String.class));
    }
