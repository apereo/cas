...
public class HttpBasedServiceCredentialTests {
    ...
    public void verifyProperUrl() {
        assertEquals(CoreAuthenticationTestUtils.CONST_GOOD_URL, 
                CoreAuthenticationTestUtils.getHttpBasedServiceCredentials().getCallbackUrl());
    }

    @Test
    public void verifyEqualsWithNull() throws Exception {
        final HttpBasedServiceCredential c = new HttpBasedServiceCredential(CNN_URL, CoreAuthenticationTestUtils.getRegisteredService(SOME_APP_URL));
        assertNotEquals(c, null);
    }

    @Test
    public void verifyEqualsWithFalse() throws Exception {
        final HttpBasedServiceCredential c = new HttpBasedServiceCredential(CNN_URL,
                CoreAuthenticationTestUtils.getRegisteredService(SOME_APP_URL));
        final HttpBasedServiceCredential c2 = new HttpBasedServiceCredential("http://www.msn.com",
                CoreAuthenticationTestUtils.getRegisteredService(SOME_APP_URL));
    ...
    public void verifyEqualsWithTrue() throws Exception {
        final HttpBasedServiceCredential c = new HttpBasedServiceCredential(CNN_URL, RegisteredServiceTestUtils.getRegisteredService(SOME_APP_URL));
        final HttpBasedServiceCredential c2 = new HttpBasedServiceCredential(CNN_URL, RegisteredServiceTestUtils.getRegisteredService(SOME_APP_URL));
    ...
    public void verifySerializeAnHttpBasedServiceCredentialToJson() throws IOException {
        final HttpBasedServiceCredential credentialMetaDataWritten = 
                new HttpBasedServiceCredential(CNN_URL,
