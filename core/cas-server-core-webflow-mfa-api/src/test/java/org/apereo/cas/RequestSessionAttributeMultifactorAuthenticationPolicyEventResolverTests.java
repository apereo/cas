 ...
 * @since 6.0.0
 */
public class RequestSessionAttributeMultifactorAuthenticationPolicyEventResolverTests extends BaseCasWebflowMfaTests {
    @Autowired
    @Qualifier("requestSessionAttributeAuthenticationPolicyWebflowEventResolver")
