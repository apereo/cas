...
public class DefaultRegisteredServiceContact implements RegisteredServiceContact {
    ...
    public boolean equals(final Object obj) {
        ...
        return builder.append(that.name, name).append(that.email, email).append(that.phone, phone).append(that.department, department).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(7, 31).append(name).append(email).append(phone).append(department).toHashCode();
    }
}
