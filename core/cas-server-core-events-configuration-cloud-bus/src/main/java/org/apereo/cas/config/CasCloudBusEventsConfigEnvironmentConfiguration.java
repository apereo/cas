...
import org.apereo.cas.support.events.listener.CasCloudBusConfigurationEventListenerImpl;
...
public class CasCloudBusEventsConfigEnvironmentConfiguration {
    ...
    public CasEventListener casCloudBusConfigurationEventListener(
        ...
        return new CasCloudBusConfigurationEventListenerImpl(manager, applicationContext);
    }
