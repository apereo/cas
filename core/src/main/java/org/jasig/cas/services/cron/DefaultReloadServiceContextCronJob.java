 ...
 *
 */
public class DefaultReloadServiceContextCronJob implements ReloadServiceContextCronJob, InitializingBean, ResourceLoaderAware {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.serviceRegistryFile = this.resourceLoader.getResource(ResourceLoader.CLASSPATH_URL_PREFIX + this.fileName).getFile();
        
        log.info("LOCATION: " + this.serviceRegistryFile);
        
        if (!this.serviceRegistryFile.exists()) {
            throw new IllegalStateException("File: " + this.serviceRegistryFile + " does not exist.");
        }
    }
