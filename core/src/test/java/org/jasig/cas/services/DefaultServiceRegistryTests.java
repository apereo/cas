...
public class DefaultServiceRegistryTests extends TestCase {
	...
	public void testAddGetServiceFromRegistry() {
		...
		assertEquals(this.authenticatedService, this.serviceRegistry.getService(this.authenticatedService.getId()));
	}
	
	public void testDeleteFoundFromServiceRegistry() {
		this.serviceRegistry.addService(this.authenticatedService);
		assertTrue(this.serviceRegistry.deleteService(this.authenticatedService.getId()));
	}
	
	public void testDeleteNotFoundFromServiceRegistry() {
		assertFalse(this.serviceRegistry.deleteService(this.authenticatedService.getId()));
	}
	
	public void testRetrieveNotFoundInServiceRegistry() {
		assertNull(this.serviceRegistry.getService(this.authenticatedService.getId()));
	}
	...
	public void testAddGetServiceExistsFromRegistry() {
		...
		assertTrue(this.serviceRegistry.serviceExists(this.authenticatedService.getId()));
	}

	public void testAddGetServiceNotExistsFromRegistry() {
		assertFalse(this.serviceRegistry.serviceExists(this.authenticatedService.getId()));
	}
