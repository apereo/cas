...
public class RemoteCentralAuthenticationServiceTests extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        this.remoteCentralAuthenticationService.setCentralAuthenticationService(this.centralAuthenticationService);
    ...
    public void testInvalidCredentials() throws TicketException {
        try {
            this.remoteCentralAuthenticationService.createTicketGrantingTicket(new UsernamePasswordCredentials());
    ...
    public void testNullCredentials() throws TicketException {
        try {
            this.remoteCentralAuthenticationService.createTicketGrantingTicket(null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            return;
        }
    ...
    public void testGrantServiceTicketWithValidTicketGrantingTicket() throws TicketException {
        ...
        final String ticketId = this.remoteCentralAuthenticationService.createTicketGrantingTicket(c);
        this.remoteCentralAuthenticationService.grantServiceTicket(ticketId, new SimpleService("test"));
    }
    ...
    public void testGrantServiceTicketWithValidCredentials() throws TicketException {
        ...
        c.setUserName("test");
        c.setPassword("test");
        final String ticketGrantingTicketId = this.remoteCentralAuthenticationService.createTicketGrantingTicket(c);
        this.remoteCentralAuthenticationService.grantServiceTicket(ticketGrantingTicketId, new SimpleService("Test"), c);
    }
    
    public void testGrantServiceTicketWithNullCredentials() throws TicketException {
        UsernamePasswordCredentials c = new UsernamePasswordCredentials();
        c.setUserName("test");
        c.setPassword("test");
        final String ticketGrantingTicketId = this.remoteCentralAuthenticationService.createTicketGrantingTicket(c);
        this.remoteCentralAuthenticationService.grantServiceTicket(ticketGrantingTicketId, new SimpleService("Test"), null);
    }
    
    public void testGrantServiceTicketWithEmptyCredentials() throws TicketException {
        UsernamePasswordCredentials c = new UsernamePasswordCredentials();
        c.setUserName("test");
        c.setPassword("test");
        final String ticketGrantingTicketId = this.remoteCentralAuthenticationService.createTicketGrantingTicket(c);
        try {
            this.remoteCentralAuthenticationService.grantServiceTicket(ticketGrantingTicketId, new SimpleService("Test"), new UsernamePasswordCredentials());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            return;
        }
    ...
    public void testValidateServiceTicketWithValidService() throws TicketException {
        ...
        c.setUserName("test");
        c.setPassword("test");
        final String ticketGrantingTicket = this.remoteCentralAuthenticationService.createTicketGrantingTicket(c);
        final String serviceTicket = this.remoteCentralAuthenticationService.grantServiceTicket(ticketGrantingTicket, new SimpleService("test"));
        
        this.remoteCentralAuthenticationService.validateServiceTicket(serviceTicket, new SimpleService("test"));
    }
    
    public void testDelegateTicketGrantingTicketWithValidCredentials() throws TicketException, MalformedURLException {
        UsernamePasswordCredentials c = new UsernamePasswordCredentials();
        c.setUserName("test");
        c.setPassword("test");
        final String ticketGrantingTicket = this.remoteCentralAuthenticationService.createTicketGrantingTicket(c);
        final String serviceTicket = this.remoteCentralAuthenticationService.grantServiceTicket(ticketGrantingTicket, new SimpleService("test"));
        this.remoteCentralAuthenticationService.delegateTicketGrantingTicket(serviceTicket, new HttpBasedServiceCredentials(new URL("https://www.acs.rutgers.edu")));
    }
    
    public void testDelegateTicketGrantingTicketWithInvalidCredentials() throws TicketException {
        UsernamePasswordCredentials c = new UsernamePasswordCredentials();
        c.setUserName("test");
        c.setPassword("test");
        final String ticketGrantingTicket = this.remoteCentralAuthenticationService.createTicketGrantingTicket(c);
        final String serviceTicket = this.remoteCentralAuthenticationService.grantServiceTicket(ticketGrantingTicket, new SimpleService("test"));
        try {
            this.remoteCentralAuthenticationService.delegateTicketGrantingTicket(serviceTicket, new UsernamePasswordCredentials());
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            return;
        }
