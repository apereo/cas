...
public class TicketStatisticsImplTests extends TestCase {
	...
	public void testProxyGrantingTicketsVended() {
		assertEquals(0, this.ticketStatistics.getNumberOfProxyGrantingTicketsVended());
		this.ticketStatistics.incrementNumberOfProxyGrantingTicketsVended();
		assertEquals(1, this.ticketStatistics.getNumberOfProxyGrantingTicketsVended());
	}
	...
	public void testTicketGrantingTicketsVended() {
		assertEquals(0, this.ticketStatistics.getNumberOfTicketGrantingTicketsVended());
		this.ticketStatistics.incrementNumberOfTicketGrantingTicketsVended();
		assertEquals(1, this.ticketStatistics.getNumberOfTicketGrantingTicketsVended());
	}
	
	public void testTicketGrantingTicketsVendedPerSecond() {
		assertTrue(0 == this.ticketStatistics.getTicketGrantingticketsPerSecond());
	}
	
	public void testProxyGrantingTicketsPerSecond() {
		assertTrue(0 == this.ticketStatistics.getProxyGrantingTicketsPerSecond());
	}
