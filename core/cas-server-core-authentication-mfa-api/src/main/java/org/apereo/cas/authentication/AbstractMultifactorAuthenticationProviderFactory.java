...
public abstract class AbstractMultifactorAuthenticationProviderFactory {
    ...
    protected void registerInstanceBean(final BaseMultifactorProviderProperties props) {
        ...
        */
        ...
        propertyValues.add(TARGET_BEAN_NAME_KEY, GenericScope.SCOPED_TARGET_PREFIX.concat(providerName));
        ...
        */
        final RootBeanDefinition scoped = ((RootBeanDefinition) applicationContext.getBeanDefinition(GenericScope.SCOPED_TARGET_PREFIX.concat(factoryBeanName))).cloneBeanDefinition();
        ...
        applicationContext.registerBeanDefinition(GenericScope.SCOPED_TARGET_PREFIX.concat(providerName), scoped);
    }
