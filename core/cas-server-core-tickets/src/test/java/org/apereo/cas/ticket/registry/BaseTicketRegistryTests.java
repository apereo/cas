...
public abstract class BaseTicketRegistryTests {
    ...
    public void verifyGetNullTicket() {
        assertNull(ticketRegistry.getTicket(null, TicketGrantingTicket.class), "Ticket should be null. useEncryption["+ useEncryption +"]");
    }

    @RepeatedTest(2)
    public void verifyGetNonExistingTicket() {
        assertNull(ticketRegistry.getTicket("FALALALALALAL", TicketGrantingTicket.class), "Ticket should be null. useEncryption["+ useEncryption +"]");
    }
    ...
    public void verifyGetNullTicketWithoutClass() {
        assertNull(ticketRegistry.getTicket(null), "Ticket should be null. useEncryption["+ useEncryption +"]");
    }

    @RepeatedTest(2)
    public void verifyGetNonExistingTicketWithoutClass() {
        assertNull(ticketRegistry.getTicket("FALALALALALAL"), "Ticket should be null. useEncryption["+ useEncryption +"]");
    }
    ...
    public void verifyDeleteExistingTicket() {
        ...
        assertNull(ticketRegistry.getTicket(ticketGrantingTicketId), "Ticket should be null. useEncryption["+ useEncryption +"]");
    }
    ...
    public void verifyDeleteNullTicket() {
        try {
            ticketRegistry.addTicket(new TicketGrantingTicketImpl(ticketGrantingTicketId,
                CoreAuthenticationTestUtils.getAuthentication(),
                new NeverExpiresExpirationPolicy()));
            assertNotEquals(1, ticketRegistry.deleteTicket(null), "Ticket was deleted.");
        } catch (final Exception e) {
            throw new AssertionError(EXCEPTION_CAUGHT_NONE_EXPECTED + e.getMessage(), e);
        }
    }
