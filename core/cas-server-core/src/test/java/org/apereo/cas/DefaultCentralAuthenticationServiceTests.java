...
public class DefaultCentralAuthenticationServiceTests extends AbstractCentralAuthenticationServiceTests {
    ...
    public void verifyGrantServiceTicketFailsAuthzRule() {
        ...
        assertThrows(PrincipalException.class,
            () -> getCentralAuthenticationService().grantServiceTicket(
                getCentralAuthenticationService().createTicketGrantingTicket(ctx).getId(), getService("TestServiceAttributeForAuthzFails"), ctx));
    }
    ...
    public void verifyGrantServiceTicketWithDifferentCredentials() {
        ...
        assertThrows(MixedPrincipalException.class, () -> getCentralAuthenticationService().grantServiceTicket(ticketGrantingTicket.getId(), getService(), ctx2));
    }
     ...
     */
    @Test
    public void verifyDestroyRemoteRegistry() {
        ...
        assertDoesNotThrow(() -> cas.destroyTicketGrantingTicket(tgt.getId()));
    }
}
