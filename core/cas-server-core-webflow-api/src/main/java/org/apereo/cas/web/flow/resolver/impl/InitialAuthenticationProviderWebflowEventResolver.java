 ...
 */
@Slf4j
public class InitialAuthenticationProviderWebflowEventResolver extends AbstractCasWebflowEventResolver {


    private final CasDelegatingWebflowEventResolver initialAuthenticationAttemptWebflowEventResolver;

    public InitialAuthenticationProviderWebflowEventResolver(final AuthenticationSystemSupport authenticationSystemSupport,
