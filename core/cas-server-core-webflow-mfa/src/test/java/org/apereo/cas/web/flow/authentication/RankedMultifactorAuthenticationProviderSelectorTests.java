...
public class RankedMultifactorAuthenticationProviderSelectorTests extends BaseCasWebflowMultifactorAuthenticationTests {
    ...
    public void verifySelectionOfMfaProvider() {
        ...
        dummy1.setOrder(10);
        dummy1.setFailureMode(MultifactorAuthenticationProviderFailureModes.PHANTOM);
        ...
        assertEquals(MultifactorAuthenticationProviderFailureModes.PHANTOM, provider.getFailureMode());
    }
